...
export default function AdminPage() {
    ...
    useEffect(() => {
        ...
        const fetchRequests = async () => {
            try {
                const response = await axiosInstance.get("/moderation/all");
    ...
    const handleRejectRequest = (id) => {
        handleRequestAction(id, "reject");
    };

    const handleRequestAction = async (id, action) => {
        try {
            const response = await axiosInstance.post(`/moderation/${id}`, {
                action,
                reason,
            });
            window.location.reload();
